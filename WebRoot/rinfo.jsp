...
<%
    	...
    	r=(Resident)request.getAttribute("r");
%>
</head>
					...
					<div class="ibox float-e-margins">
						...
						<div>
							...
							<div class="ibox-content profile-content">
								...
								</span> <span style="margin-left:20px;">${r.rname }</span> <br>
								<span> <strong>性别</strong>
								</span> <span style="margin-left:20px;">${r.rgender=="F"?"女":"男" }</span>
								<br> <span> <strong>年龄</strong>
								</span> <span style="margin-left:20px;">${r.rage }</span> <br>
								<span> <strong>地址</strong>
								</span> <span style="margin-left:20px;">${r.bname } 	&nbsp; 	&nbsp;${r.haddr }</span>
								<br> <span> <strong>联系方式</strong>
								</span> <span style="margin-left:20px;">${r.rtel }</span> <br>
